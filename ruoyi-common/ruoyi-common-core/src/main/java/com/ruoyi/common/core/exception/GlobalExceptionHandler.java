...
public class GlobalExceptionHandler {
    ...
    public Response<String> handleNotPermissionException(NotPermissionException e, HttpServletRequest request) {
        ...
        return Response.failed(CommonErrorEnum.NO_PERMISSION);
    }
    ...
    public Response<String> handleHttpRequestMethodNotSupported(HttpRequestMethodNotSupportedException e, HttpServletRequest request) {
        ...
        return Response.failed(CommonErrorEnum.REQ_METHOD_NOT_SPT);
    }
    ...
    public Response<String> handleValidationParamException(MethodArgumentNotValidException ex, HttpServletRequest request) {
        String requestURI = request.getRequestURI();
        String msg = ex.getBindingResult().getAllErrors().get(0).getDefaultMessage();
        log.error("请求地址'{}',参数校验异常'{}'", requestURI, msg);
        return Response.failed(CommonErrorEnum.PARAM_VALID_ERROR.getCode(), msg);
    }
    ...
    public Response<String> handleSystemException(Exception ex, HttpServletRequest request) {
        ...
        return Response.failed(CommonErrorEnum.INTERNAL_ERROR);
    }
